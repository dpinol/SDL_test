...
#ifndef __SDL_Game_Programming_Book__SDLBoardObject__
#define __SDL_Game_Programming_Book__SDLBoardObject__
...
#endif /* defined(__SDL_Game_Programming_Book__SDLBoardObject__) */
